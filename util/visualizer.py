...
from . import html
import scipy.misc
from util.LBP_Extractor import LBP_Extractor
try:
...
class Visualizer():
            ...
            for label, image_numpy in visuals.items():
                if isinstance(image_numpy, list):
                    for i in range(len(image_numpy)):
                        ...
                        if label == 'synthesized_lbp':
                            util.save_image(image_numpy[i], img_path, is_lbp = True)
                        else:
                    ...
                    # if label == 'synthesized_lbp':
                    #     util.save_image(image_numpy, img_path, is_lbp = True)
                    # else:
                    #     util.save_image(image_numpy, img_path)
    ...
    def convert_visuals_to_numpy(self, visuals):
        for key, t in visuals.items():
            ...
            elif 'synthesized_lbp' == key:
                t = util.tensor2gray(t)
            elif 'real_lbp' != key:
    ...
    def save_images(self, webpage, visuals, image_path):        
        ...
        for label, image_numpy in visuals.items():
            ...
            # if label == 'synthesized_lbp':
            #     util.save_image(image_numpy, save_path, create_dir=True, is_lbp = True)
            # else:
            #     util.save_image(image_numpy, save_path, create_dir=True)
